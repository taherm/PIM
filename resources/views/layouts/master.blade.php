...
<head>
	...
	<link href="{{ asset('/css/revo-slider/layers.css')}}" rel="stylesheet" media="screen" />
	<link href="{{ asset('/css/revo-slider/navigation.css')}}" rel="stylesheet" media="screen" />
	<link href="{{ asset('/css/revo-slider/settings.css')}}" rel="stylesheet" media="screen" />
...
<body>
	...
	<script src="{{ asset('/js/revo-slider/jquery.themepunch.revolution.min.js')}}"></script>
	<script src="{{ asset('/js/revo-slider/jquery.themepunch.tools.min.js')}}"></script>
